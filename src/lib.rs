...
pub use page::{
    ...
    parse_page, persist_page, Data as DataPage, General as GeneralPage, GeneralHeader,
    IndexPage as IndexData, Interval, PageType, SpaceInfo as SpaceInfoData, HEADER_SIZE,
    INNER_PAGE_SIZE, PAGE_SIZE, parse_data_page
};
