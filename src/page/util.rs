...
pub mod test {
    ...
    use crate::persistence::data::DataTypeValue;
    use crate::{map_index_pages_to_general, map_tree_index, read_data_pages, GeneralHeader, GeneralPage, IndexData, Interval, Link, PageType, SpaceInfoData, DATA_VERSION, PAGE_SIZE};
    ...
    fn test_map() {
        ...
        let res = map_tree_index::<_, { INNER_PAGE_SIZE }>(index.iter());
